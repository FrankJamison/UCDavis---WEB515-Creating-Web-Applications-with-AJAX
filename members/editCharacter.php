            ...
            <form action="<?= $ROOT ?>/members/updateCharacter.php" method="post" class="characterSheet">
                ...
                <div class="characterSheetHeader">
                    ...
                    <section class="characterName">
                        ...
                        <select name="characterName" id="characterName" tabindex="1" data-toggle="tooltip" title="Select your character">
                                ...
                                <ul>
                                    <li>
                                        ...
                                        <div class="abilityScore">
                                            ...
                                            <input name="strengthScore" id="strengthScore" placeholder="10" tabindex="8" data-toggle="tooltip" title="Enter your character's STR" />
                                        </div>
                                        <!-- End Strength Score -->
                                    ...
                                    <li>
                                        ...
                                        <div class="abilityScore">
                                            ...
                                            <input name="dexterityScore" id="dexterityScore" placeholder="10" tabindex="9" data-toggle="tooltip" title="Enter your character's DEX" />
                                        </div>
                                        <!-- End Dexterity Score -->
                                    ...
                                    <li>
                                        ...
                                        <div class="abilityScore">
                                            ...
                                            <input name="constitutionScore" id="constitutionScore" placeholder="10" tabindex="10" data-toggle="tooltip" title="Enter your character's CON" />
                                        </div>
                                    ...
                                    <li>
                                        ...
                                        <div class="abilityScore">
                                            ...
                                            <input name="intelligenceScore" id="intelligenceScore" placeholder="10" tabindex="11" data-toggle="tooltip" title="Enter your character's INT" />
                                        </div>
                                    ...
                                    <li>
                                        ...
                                        <div class="abilityScore">
                                            ...
                                            <input name="wisdomScore" id="wisdomScore" placeholder="10" tabindex="12" data-toggle="tooltip" title="Enter your character's WIS" />
                                        </div>
                                        <!-- End Wisdom Score -->
                                    ...
                                    <li>
                                        ...
                                        <div class="abilityScore">
                                            ...
                                            <input name="charismaScore" id="charismaScore" placeholder="10" tabindex="13" data-toggle="tooltip" title="Enter your character's CHA" />
                                        </div>
                                        <!-- End Charisma Score -->
